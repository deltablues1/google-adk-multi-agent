...
async def contacts_search_people(
    ...
    Args:
        query: Search query - can be name, email, or phone number
               Examples: "Tomislav Golić", "john@example.com", "+385..."
    ...
    Returns:
        Dictionary with:
        {
            ...
            "count": 2,
            "query": "Tomislav Golić"
        }

    Example:
        # Find contact by name
        result = await contacts_search_people(query="Tomislav Golić")
        if result['contacts']:
...
async def contacts_create_contact(
    ...
    Args:
        name: Full name of the contact (required)
              Example: "Davor Golić" or "Ana Horvat"
        email: Email address (optional)
               Example: "davor@example.com"
        phone: Phone number (optional)
               Example: "+385 91 558 4072" or "0915584072"
