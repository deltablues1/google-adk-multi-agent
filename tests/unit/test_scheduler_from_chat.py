...
def test_job_asked_for_in_chat_is_persisted_for_the_daemon(store):
    sched.set_delivery_target("7814915191")
    ...
    assert jobs[0].deliver_chat_id == "7814915191"   # answers where it was asked
