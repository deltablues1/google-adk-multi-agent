...
Translate TTS speaks English. Jarvis already solved both on its own Pi: Cloud
Chirp for recognition, picked after OpenAI and xAI both mis-detected Croatian as
other Slavic languages, and OpenAI 'cedar' for the voice the household already
knows. Wyoming is Home Assistant's protocol for external voice services, so this
serves what already exists rather than installing weaker copies next door.
...
_ATTRIBUTION = Attribution(
    name="Jarvis",
    url="https://github.com/deltablues1/google-adk-multi-agent",
)
