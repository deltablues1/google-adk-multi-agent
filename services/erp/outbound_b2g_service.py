...
class OutboundB2GService(OutboundB2BService):
    ...
    async def create(
        ...
        invoice_id/fail_if_exists mirror OutboundB2BService.create() — explicit
        doc ID plus Firestore create() precondition for race-free idempotency.
        ...
        invoice_id = invoice_id or str(__import__("uuid").uuid4())
